...
class PropertyPark(models.Model):
  ...
  park_name = models.CharField(default=None, max_length=250, null=True, blank=True)
  park_type = models.CharField(default=None, max_length=250, null=True, blank=True)
  POI_lat = models.FloatField(default=None, null=True, blank=True)
  POI_long = models.FloatField(default=None, null=True, blank=True)
  park_postcode = models.CharField(default=None, max_length=10, null=True, blank=True)
  ...
  property_ref = models.ForeignKey(
        ...
        related_name='parks', # this is going to be the name of the field on the one in the one-to-many relationhip. Whatever this name is, is what we'll define the field as in the populated serializer later on
