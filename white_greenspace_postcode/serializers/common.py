...
from ..models import ParksPostcode # importing Album, but this time going up one level into our albums folder using ..


class ParksPostcodeSerializer(serializers.ModelSerializer):
    # define a Meta subclass that details which model and fields to serialize
    class Meta:
        model = ParksPostcode # define model to serialize from
