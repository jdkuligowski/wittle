...
from ..models import SecondaryDetail # importing Album, but this time going up one level into our albums folder using ..


class SecondaryDetailSerializer(serializers.ModelSerializer):
    # define a Meta subclass that details which model and fields to serialize
    class Meta:
        model = SecondaryDetail # define model to serialize from
