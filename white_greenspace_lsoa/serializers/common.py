...
from ..models import ParksLsoa # importing Album, but this time going up one level into our albums folder using ..


class ParksLSOASerializer(serializers.ModelSerializer):
    # define a Meta subclass that details which model and fields to serialize
    class Meta:
        model = ParksLsoa # define model to serialize from
