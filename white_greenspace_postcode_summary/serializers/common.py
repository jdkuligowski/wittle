...
from ..models import ParksPostcodeSummary # importing Album, but this time going up one level into our albums folder using ..


class ParksSummarySerializer(serializers.ModelSerializer):
    # define a Meta subclass that details which model and fields to serialize
    class Meta:
        model = ParksPostcodeSummary # define model to serialize from
