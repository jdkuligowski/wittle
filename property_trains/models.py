...
class PropertyTrain(models.Model):
  ...
  property_ref = models.ForeignKey(
        ...
        related_name='trains', # this is going to be the name of the field on the one in the one-to-many relationhip. Whatever this name is, is what we'll define the field as in the populated serializer later on
