...
from ..models import Waitlist # importing Album, but this time going up one level into our albums folder using ..

class WaitlistSerializer(serializers.ModelSerializer):
    # define a Meta subclass that details which model and fields to serialize
    class Meta:
        model = Waitlist # define model to serialize from
