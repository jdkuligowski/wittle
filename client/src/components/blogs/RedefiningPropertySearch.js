    ...
    <>
      <section className='blog-page'>
        ...
        <section className='main-body'>
          ...
          <p className='paragraph'>Research by Eventbrite reveals a behavioural shift among the next generations: 74% of Millennials and Gen Z express a preference for experiences over desirable products. This not only reflects an overall change in purchasing attitudes, but also underscores the significance of optimal living conditions that cater to better life experiences.</p>
