...
const LivingAdminInputs = ({ loadUserData, setProfileContent, livingData, setLivingData, livingSubmit }) => {
        ...
        {livingData ?
          <>
            <section className='living-modal-details'>
              <h3>Let&apos;s add some info about your bills...</h3>
              <h5>Select the things you want to track, then add in some details</h5>
              ...
              <div className='living-modal-footer'>
                <div className='footer-submit'>
                  <h5 className='submit-text'>Happy with you selections? Load the portal 🚀</h5>
