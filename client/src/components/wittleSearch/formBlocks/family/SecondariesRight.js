    ...
    <div className='form-filling-section-2' id='restaurant-grid'>
      <div className='form-filling-grid'>
        <div className='form-filling-detail-right'>
          ...
          <select className='form-control' id='cuisine-drop-1' placeholder='Pick transport' name='secondary_model' onChange={handleChange} >Choose mode
          ...
          <div className='cuisine-dropdowns'>
            <select className='form-control' id='cuisine-drop-1' placeholder='Pick relgious requirement' name='secondary_religion' onChange={handleChange} >Pick relgion
...
export default SecondariesRight