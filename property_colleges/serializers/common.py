...
from ..models import PropertyCollege # importing our own model to define within our serializer class

# define our own serializer class - this is generic and will return all fields from the Review model
class PropertyCollegeSerializer(serializers.ModelSerializer):
    class Meta:
