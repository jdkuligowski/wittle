...
class Property(models.Model):
  ...
  let_type = models.CharField(default=None, max_length=20, null=True, blank=True)
  furnish_type = models.CharField(default=None, max_length=50, null=True, blank=True)
  deposit = models.FloatField(default=None, null=True, blank=True)
