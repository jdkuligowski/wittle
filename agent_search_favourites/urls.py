...
from .views import AddNewFavourite, DeleteFavourites

urlpatterns = [
    path('', AddNewFavourite.as_view()), # as_view passes the httprequest onto the request attribute on the view/controller
