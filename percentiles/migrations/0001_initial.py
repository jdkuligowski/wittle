    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('all_primaries', models.PositiveIntegerField(blank=True, default=None, null=True)),
                ('london_borough_primaries', models.PositiveIntegerField(blank=True, default=None, null=True)),
                ('london_region_primaries', models.PositiveIntegerField(blank=True, default=None, null=True)),
                ('secondary_score', models.PositiveIntegerField(blank=True, default=None, null=True)),
                ('all_secondaries', models.PositiveIntegerField(blank=True, default=None, null=True)),
                ('london_borough_secondaries', models.PositiveIntegerField(blank=True, default=None, null=True)),
                ('london_region_secondaries', models.PositiveIntegerField(blank=True, default=None, null=True)),
