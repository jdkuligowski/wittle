...
from ..models import RestaurantSummary # importing Album, but this time going up one level into our albums folder using ..
...
class RestaurantSummarySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = RestaurantSummary # define model to serialize from
