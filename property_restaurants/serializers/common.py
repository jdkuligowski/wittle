...
from ..models import PropertyRestaurant # importing Album, but this time going up one level into our albums folder using ..

class PropertyRestaurantSerializer(serializers.ModelSerializer):
    # define a Meta subclass that details which model and fields to serialize
    class Meta:
        model = PropertyRestaurant # define model to serialize from
