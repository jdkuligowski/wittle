...
class PropertyTakeaways(models.Model):
  ...
  deliveroo_reviews = models.PositiveIntegerField(default=None, null=True, blank=True)
  justEat_rating = models.FloatField(default=None, null=True, blank=True)
  justEat_reviews = models.PositiveIntegerField(default=None, null=True, blank=True)
