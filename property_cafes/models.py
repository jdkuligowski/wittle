...
class PropertyCafe(models.Model):
  ...
  cafe_name = models.CharField(default=None, max_length=100, null=True, blank=True)
  cleansed_name = models.CharField(default=None, max_length=100, null=True, blank=True)
  cafe_selector = models.CharField(default=None, max_length=100, null=True, blank=True)
  ...
  property_ref = models.ForeignKey(
        ...
        related_name='cafes', # this is going to be the name of the field on the one in the one-to-many relationhip. Whatever this name is, is what we'll define the field as in the populated serializer later on
