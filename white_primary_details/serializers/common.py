...
from ..models import PrimaryDetail # importing Album, but this time going up one level into our albums folder using ..


class PrimaryDetailSerializer(serializers.ModelSerializer):
    # define a Meta subclass that details which model and fields to serialize
    class Meta:
        model = PrimaryDetail # define model to serialize from
