...
class PropertySupermarket(models.Model):
  ...
  cleansed_name_value = models.FloatField(default=None, null=True, blank=True)
  size_value = models.FloatField(default=None, null=True, blank=True)
  segment_value = models.FloatField(default=None, null=True, blank=True)
