...
class PropertySecondary(models.Model):
  ...
  gender_value = models.FloatField(default=None, null=True, blank=True)
  religion_value = models.FloatField(default=None, null=True, blank=True)
  ofsted_value = models.FloatField(default=None, null=True, blank=True)
  ofsted_recency_value = models.FloatField(default=None, null=True, blank=True)
  ...
  property_ref = models.ForeignKey(
        ...
        related_name='secondaries', # this is going to be the name of the field on the one in the one-to-many relationhip. Whatever this name is, is what we'll define the field as in the populated serializer later on
