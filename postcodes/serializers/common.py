...
from ..models import Postcodes # importing Album, but this time going up one level into our albums folder using ..


class PostcodeSerializer(serializers.ModelSerializer):
    # define a Meta subclass that details which model and fields to serialize
    class Meta:
        model = Postcodes # define model to serialize from
