...
class Property(models.Model):
    ...
    channel = models.CharField(default=None, max_length=250, null=True, blank=True)
    bedrooms = models.PositiveIntegerField(default=None)
    value = models.PositiveIntegerField(default=None)
    monthly = models.PositiveIntegerField(default=None, null=True, blank=True)
    sqft = models.PositiveIntegerField(default=None, null=True, blank=True)
    tenure = models.CharField(default=None, null=True, blank=True, max_length=100)
    floorplan = models.CharField(default=None, max_length=250)
    council_tax = models.CharField(default=None, max_length=1, null=True, blank=True)
