...
from ..models import TubeSummary # importing Album, but this time going up one level into our albums folder using ..


class TubeListSerializer(serializers.ModelSerializer):
    # define a Meta subclass that details which model and fields to serialize
    class Meta:
        model = TubeSummary # define model to serialize from
