...
from ..models import PropertySearch # importing Album, but this time going up one level into our albums folder using ..
...
class PropertySearchSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = PropertySearch # define model to serialize from
