...
from ..models import SecondaryResults # importing Album, but this time going up one level into our albums folder using ..


class SecondaryResultsSerializer(serializers.ModelSerializer):
    # define a Meta subclass that details which model and fields to serialize
    class Meta:
        model = SecondaryResults # define model to serialize from
